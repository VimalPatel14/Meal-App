...
import com.vimal.mealapp.repository.MealRepository
import com.vimal.mealapp.repository.SearchMealRepository
...
class SearchMealViewModel @Inject constructor(
    private val characterRepository: SearchMealRepository
) : ViewModel() {
    ...
    fun getAllCharacter(name: String) {
        viewModelScope.launch(exceptionHandler) {
            when (val response = characterRepository.getAllCharacter(name)) {
